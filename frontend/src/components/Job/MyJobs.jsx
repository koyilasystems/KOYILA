...
//Fetching All Jobs Of An Employer
  ...
  const handleUpdateJob = async(jobId)=>{
    ...
    await axios.put(`${process.env.REACT_APP_API_URL}/api/v1/job/update/${jobId}`, updatedJob, {
      withCredentials: true
    }).then(res=>{
  ...
  const handleDeleteJob = async (jobId) =>{
    await axios.delete(`${process.env.REACT_APP_API_URL}/api/v1/job/delete/${jobId}`,  {withCredentials: true}).then(res=>{
      toast.success(res.data.message);
