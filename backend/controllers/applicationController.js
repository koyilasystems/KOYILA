...
if (!allowedFormats.includes(resume.mimetype)) {
  return next(
    new ErrorHandler("Invalid file type. Allowed: PDF, DOC, DOCX, PNG, JPG, WEBP.", 400)
  );
}

// Upload to Cloudinary
const cloudinaryResponse = await cloudinary.uploader.upload(resume.tempFilePath, {
  resource_type: "raw",       // ✅ FIXED: Allows PDF/DOC/DOCX to work for view/download
  folder: "resumes",          // optional for organization
});
